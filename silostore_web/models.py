...
class Item(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="item_list")
...
class ItemCategory(models.Model):
    ...
    item = models.ForeignKey(
        Item, blank=True, on_delete=models.CASCADE, related_name="category_list")
...
class Bid(models.Model):
    ...
    items = models.ForeignKey(
        Item, on_delete=models.CASCADE, related_name="user_bid_items", blank=True)
...
class ItemComment(models.Model):
    ...
    item = models.ForeignKey(
        Item, on_delete=models.CASCADE, related_name="comments_list")
...
class Watchlist(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='watchlist_list')
...
class AuctionHistory(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="history_user")
    items = models.ForeignKey(
        Item, on_delete=models.CASCADE, related_name="items_auction_history")
