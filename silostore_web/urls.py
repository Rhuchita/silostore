...
urlpatterns = [
    ...
    path("category_list/<str:category>",
         views.category_list_redirect, name="category_list_redirect"),
    ...
    path("delete_item_watchlist", views.delete_item_watchlist,
         name="delete_item_watchlist")
]
